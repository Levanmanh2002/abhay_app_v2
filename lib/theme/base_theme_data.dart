...
abstract class BaseThemeData {
  Color primaryColor = const Color(0xFF014FD4);
  Color secondaryColor = const Color(0XFFFFB934);
  Color thirdColor = const Color(0x0ff00000);
  Color primaryTextColor = const Color(0xFF014FD4);
  ...
  Color appColor = const Color(0xFF014FD4);
  ...
  Color black00Color = const Color(0xFF000000);
  Color whiteColor = const Color(0xFFFFFFFF);

  Color greenColor = const Color(0xFF3AC754);
  Color green4EColor = const Color(0xFF41C64E);
  ...
  Color grayColor = const Color(0xFFBABABA);
