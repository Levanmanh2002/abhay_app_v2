...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/close_circle_gray.svg
  SvgGenImage get closeCircleGray =>
      const SvgGenImage('assets/icons/close_circle_gray.svg');

  /// File path: assets/icons/close_circle_outline.svg
  SvgGenImage get closeCircleOutline =>
      const SvgGenImage('assets/icons/close_circle_outline.svg');

  /// File path: assets/icons/empty_radius.svg
  SvgGenImage get emptyRadius =>
      const SvgGenImage('assets/icons/empty_radius.svg');
  ...
  SvgGenImage get searchNormal =>
      const SvgGenImage('assets/icons/search_normal.svg');
